...
class PickerGroup extends Component {
  ...
  render() {
    const { items, prefix="mui-picker", className, height, itemHeight, indicatorTop, indicatorHeight, onChange, aniamtion, groupIndex, defaultIndex, mapKeys, ...others } = this.props;
